...
public class LineUtility
{
    ...
    public static void PatchPilotPosition(EndianBinaryWriter writer, LineRelInfo lookup, PilotID id, Vector3 position)
    {
        if (id > PilotID.Gen)
        {
    ...
    public static void PatchPilotToMachine(EndianBinaryWriter writer, LineRelInfo lookup, MachineID machine, PilotID pilot)
    {
