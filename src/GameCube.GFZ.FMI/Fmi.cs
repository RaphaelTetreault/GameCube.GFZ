...
/// <summary>
///     FMI represents various vehicle parameters, such as exhaust particle emitters,
///     pilot position, and animations objects like steering wheel or rudder/wing.
/// </summary>
public class Fmi :
    IBinaryAddressable,
    IBinarySerializable,
    IPlainTextSerializable
{
    ...
    private byte[] zeroPadding_0x34 = [];
    // REFERENCES
    private FmiEmitter[] emitters = [];
    private FmiPosition[] positions = [];
    private ShiftJisCString[] names = [];
