...
/// <summary>
///     Represents the table of stats for all vehicles.
/// </summary>
    ...
    ITableCollectionSerializable
{
    ...
    /// 
    /// </summary>
    public static readonly ShiftJisCString[] InternalPartNamesTable =
    [
        "GC-D3",
        "GC-E2",
        "AC-B2",
    ...
    /// </summary>
    public static ShiftJisCString[] MachineNamesTable =
    [
        "Rainbow Phoenix",
        "Rolling Turtle",
        "Groovy Taxi",
    ...
    public static readonly byte[] DigitsPadding =
    [
        0,
